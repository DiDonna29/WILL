...
function crearClasePersona() {
  class Persona {
    ...
    getAmigos() {
      // El método 'getAmigos' debe retornar un arreglo con solo los nombres del arreglo de amigos
      // de la persona.
      // Ej:
      // Suponiendo que la persona tiene estos amigos: [{nombre: 'toni', edad: 33},{nombre: 'Emi', edad: 25}]
      // persona.getAmigos() debería devolver ['toni', 'Emi']
